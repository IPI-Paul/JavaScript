(function (vega, vegaLite, vl, vegaTooltip, d3) {
  ...
  const csvUrl = 'http://localhost:8080/SourceFiles/csv/country.csv';
  ...
  const viz = vl__default["default"]
    ...
    .encode(
      ...
      vl__default["default"].y().title('Population').fieldQ('population'),
      vl__default["default"].tooltip().fieldN('population').format(',')
    );
  /*
    fieldN = Nominal
    fieldT = Time

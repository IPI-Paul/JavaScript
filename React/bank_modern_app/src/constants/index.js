...
export const features = [
  { id: 'feature-1', icon: star, title: 'Rewards', content: 'The best credit cards offer some tantalizing combinations of promotions and prizes.' },
  { id: 'feature-2', icon: shield, title: '100% Secured', content: 'We take proactive steps to make sure your information and transactions are secure.' },
  { id: 'feature-3', icon: send, title: 'Balance Transfer', content: 'A balance transfer credit card can save you a lot of money in interest charges.' }
];

export const feedback = [
  { id: 'feedback-1', content: 'Money is only a tool. It will take you whereever you wish, but it will not replace you as the driver.', name: 'Herman Jensen', title: 'Founder & Leader', img: people01 },
  { id: 'feedback-2', content: "Money makes your life easier. If you're lucky to have instagram, you're lucky.", name: 'Steve Mark', title: 'Founder & Leader', img: people02 },
  { id: 'feedback-3', content: 'It is usually people in the money business, finance, and international trade that are really rich.', name: 'Kenn Gallagher', title: 'Founder & Leader', img: people03 }
];
...
export const socialMedia = [
  ...
  { id: 'social-media-2', icon: facebook, link: 'https://www.facebook' },

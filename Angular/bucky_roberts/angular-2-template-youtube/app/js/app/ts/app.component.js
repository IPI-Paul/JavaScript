System.register(['angular2/core', './config.service', './video', './playlist.component', './playlist.service'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, config_service_1, video_1, playlist_component_1, playlist_service_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            AppComponent = (function () {
                function AppComponent(playlistService) {
                ...
                AppComponent.prototype.onGetUsers = function () {
                    this.playlistService.getVideos().subscribe(function (response) {
                        console.log(response);
                    }, function (error) { return console.error(error); }, function () { return console.log('Done getting videos'); });
                };
